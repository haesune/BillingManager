...
namespace ConsoleApplication5.BillingInterface
{
    class ItemCollection
    {
        ...
        public ItemCollection()
        {
            ...
            //hardcoding
            itemCollection.Add(new Item(1000, "test1", 1000));
            itemCollection.Add(new Item(1001, "test2", 100));
            itemCollection.Add(new Item(1002, "test3", 500));
